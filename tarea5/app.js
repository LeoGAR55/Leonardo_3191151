...
function mostrarMenu() {
    ...
    menu += (productos.length + 2) + ". Registrar producto nuevo a la tienda\n";
...
//Modificar la aplicacion vista en clase del 09092024 y agregar un modulo para poder agregar articulos al carro de compras
function registrarProducto(){
    var nombre1 = prompt("Porfavor digite el nombre del producto");
    var precio1 = parseInt(prompt("Porfavor digite el precio del producto"));
    if (isNaN(precio1)){
        console.log("Error, el precio ingresado no es un número")
    }else{
        productos.push({nombre: nombre1,precio: precio1 });
...
do {
    ...
    if (isNaN(opcion) || opcion < 1 || opcion > productos.length + 2) {
        ...
        // Si elige registrar un producto nuevo
        registrarProducto();
    }
